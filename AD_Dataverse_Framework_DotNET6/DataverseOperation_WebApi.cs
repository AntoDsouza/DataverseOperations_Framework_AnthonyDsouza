namespace AD_Dataverse_Framework_DotNET6
{
    using AD_Dataverse_Framework_DotNET6.Helper;
    ...
    public static class DataverseOperation_WebApi
    {
        ...
        public static ServiceClient GetCrmServiceClient()
        {
            try
            {
                ...
                var conn = new ServiceClient($@"AuthType=ClientSecret;url={dataverseURL};ClientId={applicationUserClientId};ClientSecret={applicationUserClientSecret}");
